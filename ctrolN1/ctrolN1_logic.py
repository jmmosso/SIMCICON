...
if (TAMB > TEMP_AMB_MAX):
    if (TUPS > TEMP_UPS_MAX):
     	print 'Excepcion 1: Temperatura en CDD y  UPS (salD2=1)'
	sal2 = IOdirN1 + '/' + sal + repr(2)	
#	sal2FULL = os.path.join(variablesG.G_DIR_BASE, sal2)
#	print sal2FULL
	with open(os.path.join(variablesG.G_DIR_BASE, sal2), 'w') as f:
    	   f.write('1')
	logger_ctrolN1.critical('Exceso de temperaturas TAMB y TUPS...')
...
#     print sal2FULL
     with open(os.path.join(variablesG.G_DIR_BASE, sal2), 'w') as f:
        f.write('0')
     logger_ctrolN1.info('Temperaturas TAMB y TUPS OK!...')
